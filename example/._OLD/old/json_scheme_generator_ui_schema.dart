...
class JsonSchemaGeneratorUiSchema {
...
// case 'array':
  ...
  static Widget buildTextField(
    ...
    if (uiSchema == null) {
      ...
      formControlName = fieldName(uiSchema).join('.');
  ...
  static List<String> scopes(Map<String, dynamic> uiSchema) {
    return uiSchema['scope'].toString().split('/')..removeAt(0);
  }

  static List<String> fieldName(Map<String, dynamic> uiSchema) {
    return uiSchema['scope'].toString().replaceAll('properties/', '').split('/')
      ..removeAt(0);
  }
